...
_P(NDPI_PROTOCOL_HTTP_APPLICATION_VEOHTV),
...
_P(NDPI_PROTOCOL_MSSQL),
_P(NDPI_PROTOCOL_PPTP),
_P(NDPI_PROTOCOL_WARCRAFT3),
_P(NDPI_PROTOCOL_WORLD_OF_KUNG_FU),
_P(NDPI_PROTOCOL_MEEBO),
_P(NDPI_SERVICE_FACEBOOK),
_P(NDPI_SERVICE_TWITTER),
_P(NDPI_PROTOCOL_DROPBOX),
_P(NDPI_SERVICE_GMAIL),
_P(NDPI_SERVICE_GOOGLE_MAPS),
_P(NDPI_SERVICE_YOUTUBE),
_P(NDPI_PROTOCOL_SKYPE),
_P(NDPI_SERVICE_GOOGLE),
...
_P(NDPI_SERVICE_NETFLIX),
_P(NDPI_SERVICE_LASTFM),
_P(NDPI_SERVICE_WAZE),
_P(NDPI_PROTOCOL_SKYFILE_PREPAID),
_P(NDPI_PROTOCOL_SKYFILE_RUDICS),
_P(NDPI_PROTOCOL_SKYFILE_POSTPAID),
_P(NDPI_PROTOCOL_CITRIX_ONLINE),
_P(NDPI_SERVICE_APPLE),
_P(NDPI_PROTOCOL_WEBEX),
_P(NDPI_SERVICE_WHATSAPP),
_P(NDPI_SERVICE_APPLE_ICLOUD),
_P(NDPI_PROTOCOL_VIBER),
_P(NDPI_SERVICE_APPLE_ITUNES),
_P(NDPI_PROTOCOL_RADIUS),
_P(NDPI_SERVICE_WINDOWS_UPDATE),
_P(NDPI_PROTOCOL_TEAMVIEWER),
_P(NDPI_SERVICE_TUENTI),
...
_P(NDPI_PROTOCOL_SOCKS5),
_P(NDPI_PROTOCOL_SOCKS4),
_P(NDPI_PROTOCOL_RTMP),
_P(NDPI_PROTOCOL_FTP_DATA),
_P(NDPI_SERVICE_WIKIPEDIA),
_P(NDPI_PROTOCOL_ZMQ),
_P(NDPI_SERVICE_AMAZON),
_P(NDPI_SERVICE_EBAY),
_P(NDPI_SERVICE_CNN),
...
_P(NDPI_SERVICE_VEVO),
_P(NDPI_SERVICE_PANDORA),
_P(NDPI_PROTOCOL_QUIC),
_P(NDPI_PROTOCOL_WHATSAPP_VOICE),
_P(NDPI_PROTOCOL_EAQ),
_P(NDPI_SERVICE_TIMMEU),
_P(NDPI_SERVICE_TORCEDOR),
_P(NDPI_SERVICE_KAKAOTALK),
_P(NDPI_SERVICE_KAKAOTALK_VOICE),
_P(NDPI_SERVICE_TWITCH),
_P(NDPI_SERVICE_QUICKPLAY),
_P(NDPI_SERVICE_TIM),
_P(NDPI_PROTOCOL_MPEGTS),
_P(NDPI_SERVICE_SNAPCHAT),
_P(NDPI_SERVICE_SIMET),
_P(NDPI_SERVICE_OPENSIGNAL),
_P(NDPI_SERVICE_99TAXI),
_P(NDPI_SERVICE_EASYTAXI),
_P(NDPI_SERVICE_GLOBOTV),
_P(NDPI_SERVICE_TIMSOMDECHAMADA),
_P(NDPI_SERVICE_TIMMENU),
_P(NDPI_SERVICE_TIMPORTASABERTAS),
_P(NDPI_SERVICE_TIMRECARGA),
_P(NDPI_SERVICE_TIMBETA),
_P(NDPI_SERVICE_DEEZER),
_P(NDPI_SERVICE_INSTAGRAM),
_P(NDPI_SERVICE_MICROSOFT),
_P(NDPI_PROTOCOL_STARCRAFT),
_P(NDPI_PROTOCOL_TEREDO),
_P(NDPI_SERVICE_HOTSPOT_SHIELD),
